...
#     except:
#         return Response({"error": "Please send num1, num2 & opr"}, status=status.HTTP_400_BAD_REQUEST)
#     else:
...
#         else:
#             return Response({"error": "Please send num1 & num2 as integer"}, status=status.HTTP_400_BAD_REQUEST)
